...
#
#SBATCH -o HLR_plotsAd.out
#SBATCH -e HLR_plotsAd.err
...
srun python3 ./plots_Advanced_headless.py PR009 /ptmp/muellerg/ 92
srun python3 ./plots_Advanced_headless.py PR009 /ptmp/muellerg/ 37

srun python3 ./plots_Advanced_headless.py PR012 /ptmp/muellerg/ 92
srun python3 ./plots_Advanced_headless.py PR012 /ptmp/muellerg/ 37
