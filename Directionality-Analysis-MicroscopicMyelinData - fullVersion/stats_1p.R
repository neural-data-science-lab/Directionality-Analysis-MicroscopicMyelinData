...
library(MASS)
write.matrix(sample.Intercept, file="/ptmp/muellerg/bpnr1p_Intercept_VCx.csv")
write.matrix(sample.sider, file="/ptmp/muellerg/bpnr1p_side2_VCx.csv")
write.matrix(sample.fit, file="/ptmp/muellerg/bpnr1p_fit_VCx.csv")
write.matrix(sample.beta1_1, file="/ptmp/muellerg/bpnr1p_beta1_1_VCx.csv")
write.matrix(sample.beta1_2, file="/ptmp/muellerg/bpnr1p_beta1_2_VCx.csv")
write.matrix(sample.beta2_1, file="/ptmp/muellerg/bpnr1p_beta2_1_VCx.csv")
write.matrix(sample.beta2_2, file="/ptmp/muellerg/bpnr1p_beta2_2_VCx.csv")
