...
Combine data for statistical analysis after directionality analysis and plots for statistics
    - fuse data
    - visualize data (distributions, boxplots, ...)
    - plots for statistical evaluation
'''
