...
write.matrix(sample.sider, file="/ptmp/muellerg/bpnr3p_sider_VCx.csv")
write.matrix(sample.layerL4, file="/ptmp/muellerg/bpnr3p_layerL4_VCx.csv")
write.matrix(sample.layerL5, file="/ptmp/muellerg/bpnr3p_layerL5_VCx.csv")
write.matrix(sample.siderlayerL4, file="/ptmp/muellerg/bpnr3p_siderlayerL4_VCx.csv")
write.matrix(sample.siderlayerL5, file="/ptmp/muellerg/bpnr3p_siderlayerL5_VCx.csv")
write.matrix(sample.layerL4layerL5, file="/ptmp/muellerg/bpnr3p_layerL4layerL5_VCx.csv")
write.matrix(sample.fit, file="/ptmp/muellerg/bpnr3p_fit_VCx.csv")
write.matrix(sample.beta1_1, file="/ptmp/muellerg/bpnr3p_beta1_1_VCx.csv")
write.matrix(sample.beta1_2, file="/ptmp/muellerg/bpnr3p_beta1_2_VCx.csv")
write.matrix(sample.beta1_3, file="/ptmp/muellerg/bpnr3p_beta1_3_VCx.csv")
write.matrix(sample.beta1_4, file="/ptmp/muellerg/bpnr3p_beta1_4_VCx.csv")
write.matrix(sample.beta1_5, file="/ptmp/muellerg/bpnr3p_beta1_5_VCx.csv")
write.matrix(sample.beta2_1, file="/ptmp/muellerg/bpnr3p_beta2_1_VCx.csv")
write.matrix(sample.beta2_2, file="/ptmp/muellerg/bpnr3p_beta2_2_VCx.csv")
