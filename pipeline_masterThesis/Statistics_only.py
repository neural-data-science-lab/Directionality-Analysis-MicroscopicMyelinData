...
def plot_Statistics(name_data, path, statistics, patch_size, save_path, slice=0): #cividis, PuOr,
...
s = statistics(name_cortex, name_otsu, path, path_directionality, patch_size, colnames, header = True)
