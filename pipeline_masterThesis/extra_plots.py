...
result = pd.read_csv(path + 'Result_PR014_r_ACx_37_Fiji_Directionality_.csv')
...
plot_color2D_layerTonotopy(s, nbr_s, path, patch_size, method, name, annontation = False, cmap = 'twilight_r', pixel = 0.5417)
