...
library(MASS)
write.matrix(y, file="/ptmp/muellerg/mean_y_C3.csv")
write.matrix(s, file="/ptmp/muellerg/std_y_C3.csv")
#write.matrix(sample.AS, file="/ptmp/muellerg/bpnr3p_AS_C3.csv")
