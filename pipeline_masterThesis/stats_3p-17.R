...
library(MASS)
write.matrix(sample.Intercept, file="/ptmp/muellerg/bpnr3p_Intercept_17.csv")
write.matrix(sample.sider, file="/ptmp/muellerg/bpnr3p_sider_17.csv")
write.matrix(sample.layerL4, file="/ptmp/muellerg/bpnr3p_layerL4_17.csv")
write.matrix(sample.layerL5, file="/ptmp/muellerg/bpnr3p_layerL5_17.csv")
write.matrix(sample.siderlayerL4, file="/ptmp/muellerg/bpnr3p_siderlayerL4_17.csv")
write.matrix(sample.siderlayerL5, file="/ptmp/muellerg/bpnr3p_siderlayerL5_17.csv")
write.matrix(sample.layerL4layerL5, file="/ptmp/muellerg/bpnr3p_layerL4layerL5_17.csv")
write.matrix(sample.fit, file="/ptmp/muellerg/bpnr3p_fit_17.csv")
write.matrix(sample.beta1_1, file="/ptmp/muellerg/bpnr3p_beta1_1_17.csv")
write.matrix(sample.beta1_2, file="/ptmp/muellerg/bpnr3p_beta1_2_17.csv")
write.matrix(sample.beta1_3, file="/ptmp/muellerg/bpnr3p_beta1_3_17.csv")
write.matrix(sample.beta1_4, file="/ptmp/muellerg/bpnr3p_beta1_4_17.csv")
write.matrix(sample.beta1_5, file="/ptmp/muellerg/bpnr3p_beta1_5_17.csv")
write.matrix(sample.beta2_1, file="/ptmp/muellerg/bpnr3p_beta2_1_17.csv")
write.matrix(sample.beta2_2, file="/ptmp/muellerg/bpnr3p_beta2_2_17.csv")
write.matrix(sample.beta2_3, file="/ptmp/muellerg/bpnr3p_beta2_3_17.csv")
write.matrix(sample.beta2_4, file="/ptmp/muellerg/bpnr3p_beta2_4_17.csv")
write.matrix(sample.beta2_5, file="/ptmp/muellerg/bpnr3p_beta2_5_17.csv")
