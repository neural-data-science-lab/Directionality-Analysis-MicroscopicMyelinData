...
fit.mode_lag1 = bpnr(pred.I = domDir ~ side_num,
                      data = dataL1_18,
                      its = 20000, burn = 3500, n.lag = 1, seed = 101)
save(fit.mode_lag1, file = "/ptmp/muellerg/fit.mode_bpnr_lag1.rda")
gc()

#include fixed-effects, simplest within-subject factors
fit.mode_lag2 = bpnr(pred.I = domDir ~ side_num,
                      data = dataL1_18,
                      its = 20000, burn =3500, n.lag = 2, seed = 101)
save(fit.mode_lag2, file = "/ptmp/muellerg/fit.mode_bpnr_lag2.rda")
gc()

fit.mode_lag3 = bpnr(pred.I = domDir ~ side_num,
                      data = dataL1_18,
                      its = 20000, burn = 3500, n.lag = 3, seed = 101)
save(fit.mode_lag3, file = "/ptmp/muellerg/fit.mode_bpnr_lag3.rda")
gc()

fit.mode_lag5 = bpnr(pred.I = domDir ~ side_num,
                      data = dataL1_18,
                      its = 20000, burn = 3500, n.lag = 5, seed = 101)
save(fit.mode_lag5, file = "/ptmp/muellerg/fit.mode_bpnr_lag5.rda")
gc()

fit.mode_lag7 = bpnr(pred.I = domDir ~ side_num,
                      data = dataL1_18,
                      its = 20000, burn = 3500, n.lag = 7, seed = 101)
save(fit.mode_lag7, file = "/ptmp/muellerg/fit.mode_bpnr_lag7.rda")