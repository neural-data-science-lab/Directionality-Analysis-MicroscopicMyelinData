...
library(MASS)
write.matrix(sample.SAM, file="/ptmp/muellerg/bpnr3p_SAM_17.csv")
write.matrix(sample.bc, file="/ptmp/muellerg/bpnr3p_bc_17.csv")
write.matrix(sample.AS, file="/ptmp/muellerg/bpnr3p_AS_17.csv")
