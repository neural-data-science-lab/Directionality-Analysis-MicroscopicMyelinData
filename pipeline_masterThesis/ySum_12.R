...
m[1,] = colMeans(sample.SAM)
m[2,] = colMeans(sample.bc)
m[3,] = colMeans(sample.AS)
...
library(MASS)
write.matrix(m, file="/ptmp/muellerg/mean_y_12.csv")
write.matrix(s, file="/ptmp/muellerg/std_y_12.csv")
#write.matrix(sample.AS, file="/ptmp/muellerg/bpnr3p_AS_VCx.csv")
