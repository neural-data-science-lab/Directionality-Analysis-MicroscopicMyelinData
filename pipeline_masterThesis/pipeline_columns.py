...
open_path     = r"D:\Data"  #path to folder with images (in h5 format if h5 == True)

### tuple of image names to be processed
img_names = (r"\stack.tif",)#images with structures to be annotated

save_path     = r"D:\Data\results"  #path to results folder
