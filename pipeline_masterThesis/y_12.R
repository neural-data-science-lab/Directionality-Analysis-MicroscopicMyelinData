...
library(MASS)
write.matrix(sample.SAM, file="/ptmp/muellerg/bpnr3p_SAM_12.csv")
write.matrix(sample.bc, file="/ptmp/muellerg/bpnr3p_bc_12.csv")
write.matrix(sample.AS, file="/ptmp/muellerg/bpnr3p_AS_12.csv")
